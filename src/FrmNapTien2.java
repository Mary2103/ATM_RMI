 ...
 * @author admin
 */
public class FrmNapTien2 extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(39, 39, 39)
                .addComponent(Naptien, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void NaptienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NaptienActionPerformed
        ...
        try {
            ...
            if (tong > 20000000) {
                JOptionPane.showMessageDialog(this, "Bạn chỉ được nạp tối đa 20tr/1day");
                sotien.setText("");
                Object[] options = {"Có",
                    "Thoát"};
                ...
                if (st > 50000) {
                    if (t != 0) {
                        JOptionPane.showMessageDialog(this, "Số tiền nạp phải là bội số của 50000");
                    } else {
                        server.NapTien(st, un);
                        ...
                        int n = JOptionPane.showOptionDialog(this,
                                "Bạn có muốn nạp tiền tiếp không?",
                                "Chọn 1 lựa chọn",
                                JOptionPane.YES_NO_OPTION,
                                JOptionPane.QUESTION_MESSAGE,
                                null,
                    ...
                    JOptionPane.showMessageDialog(this, "Số tiền nạp phải lớn hơn 50000");
                }
            }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        long tien = FrmNapTien.sotiennap;
        if (tien != 0) {
